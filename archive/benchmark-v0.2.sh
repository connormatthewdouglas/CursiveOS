#!/bin/bash
echo "=== CursiveOS Benchmark v0.2 (AMD CPU + Intel GPU) ==="
...
# Apply CursiveOS v0.2 tweaks
echo ""
echo "Applying CursiveOS v0.2 tweaks..."
...
# Re-test
echo ""
echo "AFTER CursiveOS v0.2:"
sensors | grep -E 'Core|Package|temp' | head -n 4 || echo "CPU temps not detected"
sysbench cpu run --threads=$(nproc) --cpu-max-prime=20000 | grep "events per second"
ping -c 3 8.8.8.8 | grep "rtt"

echo ""
echo "✅ CursiveOS v0.2 complete!"

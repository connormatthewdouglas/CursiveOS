...
export const GAPS: Gap[] = [
  ...
  },
  {
    ...
    why: "Queue drafts, proposer, cycle close, and write-policy simulator run here. They still do not write live CursiveRoot.",
    status: "partial",
    evidence: "this console; dashboard/README.md remains read-only",
  },
  {
    id: "legacy-hub",
    area: "hub",
  ...
  },
  {
    ...
    why: "Default propose() refuses empty QD and will not emit pagecluster/vfs cousins. Remaining library knobs are operator opt-in. Live QD archive is still unwired.",
    status: "partial",
    evidence: "propose.ts; tools/qd_organism.py still a simulation",
  },
  {
    id: "auto-enqueue",
    area: "workflow",
  ...
  },
  {
    ...
    status: "partial",
    evidence: "policy.ts; 20260702000000_os0_queue_rls_hardening.sql",
  },
  {
    id: "backup-secrets",
    area: "infra",
